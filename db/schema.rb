...
ActiveRecord::Schema.define(version: 2018_06_18_061039) do
  ...
  create_table "movie_ratings", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "movie_id"
    t.integer "ratings"
    t.datetime "created_at", null: false
  ...
  create_table "user_reviews", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["movie_id"], name: "index_user_reviews_on_movie_id"
